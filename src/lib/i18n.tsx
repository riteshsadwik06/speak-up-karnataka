...
export const DICT = {
  ...
  tabKannadaPost: { en: "ಕನ್ನಡ (ಅಂಚೆ ಮೂಲಕ ಮಾತ್ರ)", kn: "ಕನ್ನಡ (ಅಂಚೆ ಮೂಲಕ ಮಾತ್ರ)" },
  tabEnglishPortal: { en: "English (portal)", kn: "English (portal)" },
  postalNote: {
    en: "The online portal accepts Latin characters only, so a Kannada application must be sent by post. Both versions are legally valid — the Act permits English, Hindi or the official language of the area.",
    kn: "ಆನ್‌ಲೈನ್ ಪೋರ್ಟಲ್ ಕೇವಲ ಇಂಗ್ಲಿಷ್ ಅಕ್ಷರಗಳನ್ನು ಮಾತ್ರ ಸ್ವೀಕರಿಸುತ್ತದೆ. ಆದ್ದರಿಂದ ಕನ್ನಡದ ಅರ್ಜಿಯನ್ನು ಅಂಚೆ ಮೂಲಕವೇ ಸಲ್ಲಿಸಬೇಕು. ಎರಡೂ ಆವೃತ್ತಿಗಳು ಕಾನೂನುಬದ್ಧವಾಗಿ ಮಾನ್ಯ — ಕಾಯ್ದೆಯು ಇಂಗ್ಲಿಷ್, ಹಿಂದಿ ಅಥವಾ ಆ ಪ್ರದೇಶದ ಅಧಿಕೃತ ಭಾಷೆಯನ್ನು ಅನುಮತಿಸುತ್ತದೆ.",
  },
  postalOnly: { en: "By post only", kn: "ಅಂಚೆ ಮೂಲಕ ಮಾತ್ರ" },
  translating: { en: "Preparing the Kannada version…", kn: "ಕನ್ನಡ ಆವೃತ್ತಿ ಸಿದ್ಧವಾಗುತ್ತಿದೆ…" },
